...
export class UsersComponent implements OnInit {
  ...
  editUser(p: any) {
    ...
    this.UserForm.controls.Cnic.setValue(p.cnic);
    this.UserForm.controls.companyID.setValue(p.companyID);
    this.UserForm.controls.Designation.setValue(p.designation);
    this.UserForm.controls.DOB.setValue(p.dob);
    this.UserForm.controls.Email.setValue(p.email);
    this.UserForm.controls.Gender.setValue(p.gender);
    this.UserForm.controls.isActive.setValue(p.isActive);
    this.UserForm.controls.MobileNo.setValue(p.mobileNo);
    this.UserForm.controls.Name.setValue(p.name);
    this.UserForm.controls.ownerId.setValue(p.ownerId);
    this.UserForm.controls.Password.setValue(p.password);
    this.UserForm.controls.confirmPassword.setValue(p.password);
    this.UserForm.controls.userID.setValue(p.userID);
    this.UserForm.controls.willLogin.setValue(p.willLogin);
  }
